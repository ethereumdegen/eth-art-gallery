...
<template>
    <div class="relative">
      ...
      <button @click="open = !open" class="relative flex items-center focus:outline-none">
        ...
        <span class="ml-2 font-medium truncate text-white" style="max-width:80px">{{acctAddress}}</span>
      ...
      >
        <div v-if="open" class="origin-top-right absolute right-0 mt-2 w-256 bg-white rounded-lg border shadow-md py-2">
          <ul>
            ...
            <li>
              <a href="https://swapmatic.io/swap" target="_blank" class="block px-4 py-2 hover:bg-indigo-500 hover:text-white">Swapmatic.io</a>
            </li>
            <hr>
            <li>
