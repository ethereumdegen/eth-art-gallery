...
import MetaPacketHelper from './meta-packet-helper'
import MetaPacketUtils from './meta-packet-utils'


//import EthHelper from './ethhelper'

import Web3Plug from './web3Plug'
...
export default class MetaWalletHelper {
...
/*
   ...
   if(this.web3 != null)
   {
        ...
        web3.version.getNetwork((err, netId) => {
          ...
          switch (netId) {
            case "1":
              ...
              break
            case "5":
              self.networkVersion = 'goerli';
              console.log('Web3 is using goerli test network.');

            case "42":
              self.networkVersion = 'kovan';
              console.log('Web3 is using kovan test network.');

            case "100":
              self.networkVersion = 'xdai';
              console.log('Web3 is using kodan test network.');
      ...
      // init defaultTokenData
        ...
        console.log('defaultTokenData',defaultTokenData)
